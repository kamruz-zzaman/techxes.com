...
const SingleService = () => {
    ...
    useEffect(() => {
        setLoading(true)
        axios.get(`https://techxes.herokuapp.com/api/services/${id}?populate=*`)
            .then(res => {
                setLoading(false)
        ...
        <>
            {
                loading ? (
                    ...
                    <>
                        <div className='container text-left w-full md:w-3/5 mx-auto'>
                            ...
                            <div className=''>
                                <img src={data.attributes.icon.data.attributes.url} alt='' />
                                <h3 className='font-medium text-3xl my-5'>
                                    {data.attributes.title} <br /><br />
