					...
					<form onSubmit={handleCareerForm}>
						...
						<div className='flex justify-center'>
							<div className=''>
								<input
									name='Name'
									className='bg-transparent border-2 border-white px-3 py-2 text-white mb-6 rounded-lg w-80 md:w-96'
									type='text'
									placeholder='Name'
								/>
								<br />
								...
								<div className='flex justify-center mb-6'>
									<select
										className='text-black font-semibold py-2 px-3 rounded-lg'
										name='position'
										id=''>
										<option>UI UX</option>
										<option>Hr</option>
								...
								<div className='flex justify-center '>
									<button
										type='submit'
										value='Submit'
										className='border-2 cursor-pointer px-7 py-1 rounded-lg flex items-center'>
										{loading ? (
											<svg
												role='status'
